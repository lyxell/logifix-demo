...
editor: main.o editor.o filepicker.o dockspace.o ast.o logifix/program.o logifix/sjp/parser.o logifix/sjp/lexer.o imedit/imedit.o ImGuiFileDialog.o $(IMGUI_BOILERPLATE_ARCHIVE)
	$(CXX) -o $@ $^ $(LIBS)
